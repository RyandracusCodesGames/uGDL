...
/*3dfx Glide API Inspired Alpha Blending*/
#define COMBINE_COLOR_BOTHINVALPHA 			0x22
#define COMBINE_COLOR_INVDESTALPHA 			0x23
#define COMBINE_COLOR_BOTHSRCALPHA 			0x24
typedef struct{
	int r, g, b;
}uGDL_RGB;
